...
namespace StoreAppDL.Migrations
{
    ...
    [Migration("20210726193210_initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("StoreAppModel.Manager", b =>
                {
                    ...
                    b.Property<int?>("ManagerStoreStoreFrontID")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("ManagerStoreStoreFrontID");
            ...
            modelBuilder.Entity("StoreAppModel.Order", b =>
                {
                    ...
                    b.Property<int?>("OrderLocationStoreFrontID")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("OrderLocationStoreFrontID");
            ...
            modelBuilder.Entity("StoreAppModel.LineItem", b =>
                {
                    b.HasOne("StoreAppModel.Customer", null)
            ...
            modelBuilder.Entity("StoreAppModel.Manager", b =>
                {
                    b.HasOne("StoreAppModel.StoreFront", "ManagerStore")
                        .WithMany()
                        .HasForeignKey("ManagerStoreStoreFrontID");

                    b.Navigation("ManagerStore");
                });
            ...
            modelBuilder.Entity("StoreAppModel.Order", b =>
                {
                    ...
                    b.HasOne("StoreAppModel.StoreFront", "OrderLocation")
                        .WithMany("StoreFrontOrders")
                        .HasForeignKey("OrderLocationStoreFrontID");
